    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <div class="d-flex justify-content-between">
                <h3 class="m-0 font-weight-bold text-primary">Client</h3>
                <a href="/dashboard/client/create" class="btn btn-primary btn-icon-split ml-2">
                        ...
                        @forelse ($clients as $client)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="#" class="btn btn-sm btn-danger" onclick="hapus({{ $client->id }})"
...
@push('script')
    ...
    <script>
        function hapus(id) {
            $('#hapusForm').attr('action', `/dashboard/client/${id}`);
        }
    </script>
    <script>
